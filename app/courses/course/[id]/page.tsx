...
import { CourseAITools } from "@/components/course-ai-tools"
          ...
          <div className="container mx-auto max-w-5xl px-4 py-6 md:px-6 md:py-8">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="mb-6">
              <TabsList>
                ...
                <TabsTrigger value="ai-tools">AI Learning Tools</TabsTrigger>
              </TabsList>
                  ...
                  <div className="flex gap-2">
                    {currentLesson.prevLesson && (
                      <Button variant="outline" className="flex items-center gap-2" asChild>
                        <Link href={`/courses/${params.id}?lesson=${currentLesson.prevLesson}`}>
                    ...
                    {currentLesson.nextLesson && (
                      <Button className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700" asChild>
                        <Link href={`/courses/${params.id}?lesson=${currentLesson.nextLesson}`}>
                          Next Lesson
              ...
              <TabsContent value="ai-tools" className="mt-6">
                <CourseAITools
                  ...
                  courseTopic={currentLesson.title}
