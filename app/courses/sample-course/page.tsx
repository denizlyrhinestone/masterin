...
export const metadata: Metadata = {
  title: "Sample Course - Masterin",
  description: "Learn with our comprehensive sample course",
}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-6">
              <div>
                <h1 className="text-3xl font-bold mb-4">Sample Course: Introduction to Learning</h1>
                <p className="text-gray-600 dark:text-gray-300 text-lg">
                  This is a comprehensive sample course designed to demonstrate the learning platform capabilities.
                  Learn the fundamentals and advanced concepts through interactive lessons.
                </p>
              </div>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="border rounded-lg p-4">
                      <h3 className="font-semibold mb-2">Lesson 1: Introduction</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                        Get started with the basics and understand the course structure.
                      </p>
                    ...
                    <div className="border rounded-lg p-4">
                      <h3 className="font-semibold mb-2">Lesson 2: Getting Started</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                        Learn the fundamental concepts and prepare for advanced topics.
                      </p>
                      <div className="flex items-center justify-between">
                    ...
                    <div className="border rounded-lg p-4 opacity-60">
                      <h3 className="font-semibold mb-2">Lesson 3: Advanced Concepts</h3>
                      <p className="text-sm text-gray-600 dark:text-gray-300 mb-2">
                        Dive deeper into advanced topics and practical applications.
                      </p>
                      <div className="flex items-center justify-between">
