  ...
  return (
    <div className="container mx-auto px-4 py-12 mt-16">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-8">
        <p className="text-gray-600 dark:text-gray-300 mb-6">Have questions or need support? Reach out to our team.</p>

        <p className="text-gray-600 dark:text-gray-300 mb-6">Email: support@masterin.ai</p>
      </div>
