      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/educators" className="hover:text-emerald-500">
                  Educators
                </Link>
              </li>
              <li>
                <Link href="/ai-tutor" className="hover:text-emerald-500">
                  AI Tutor
                </Link>
              </li>
              <li>
                <Link href="/community" className="hover:text-emerald-500">
                  Community
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/faq" className="hover:text-emerald-500">
                  FAQs
                </Link>
              </li>
              <li>
                <Link href="/testimonials" className="hover:text-emerald-500">
                  Testimonials
                </Link>
              </li>
              <li>
                <Link href="/careers" className="hover:text-emerald-500">
                  Careers
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center">
          ...
          <div className="mt-2 flex justify-center space-x-4 text-sm">
            ...
            <Link href="/cookies" className="hover:text-emerald-500">
              Cookie Policy
            </Link>
          </div>
        </div>
